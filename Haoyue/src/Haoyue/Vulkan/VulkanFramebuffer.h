...
namespace Haoyue {
	...
	public:
		...
		virtual Ref<Image2D> GetImage(uint32_t attachmentIndex = 0) const override { HY_CORE_ASSERT(attachmentIndex < m_Attachments.size()); return m_Attachments[attachmentIndex]; }
