...
namespace Haoyue {
	...
	void VulkanContext::Create()
	{
		...
		HY_CORE_ASSERT(glfwVulkanSupported(), "GLFW must support Vulkan!");
		...
		appInfo.pApplicationName = "Haoyue";
		appInfo.pEngineName = "Haoyue";
...
#define VK_KHR_WIN32_SURFACE_EXTENSION_NAME "VK_KHR_win32_surface"
		...
		if (s_Validation)
		{
			...
			HY_CORE_ASSERT(vkCreateDebugReportCallbackEXT != NULL, "");
