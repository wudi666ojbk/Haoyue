...
namespace Haoyue {
	...
	void VulkanSwapChain::InitSurface(GLFWwindow* windowHandle)
	{
		...
		HY_CORE_ASSERT(graphicsQueueNodeIndex != UINT32_MAX);
		HY_CORE_ASSERT(presentQueueNodeIndex != UINT32_MAX);
	...
	void VulkanSwapChain::Create(uint32_t* width, uint32_t* height, bool vsync)
	{
		...
		HY_CORE_ASSERT(presentModeCount > 0, "");
