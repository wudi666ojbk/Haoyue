...
namespace Haoyue {
	...
	float PhysicsActor::GetMass() const
	{
		if (!IsDynamic())
		{
			HY_CORE_WARN("Trying to set mass of non-dynamic PhysicsActor.");
			return 0.0F;
		}
	...
	void PhysicsActor::AddForce(const glm::vec3& force, ForceMode forceMode)
	{
		if (!IsDynamic())
		{
			HY_CORE_WARN("Trying to add force to non-dynamic PhysicsActor.");
			return;
		}
	...
	void PhysicsActor::AddTorque(const glm::vec3& torque, ForceMode forceMode)
	{
		if (!IsDynamic())
		{
			HY_CORE_WARN("Trying to add torque to non-dynamic PhysicsActor.");
			return;
		}
	...
	glm::vec3 PhysicsActor::GetLinearVelocity() const
	{
		if (!IsDynamic())
		{
			HY_CORE_WARN("Trying to get velocity of non-dynamic PhysicsActor.");
	...
	void PhysicsActor::SetLinearVelocity(const glm::vec3& velocity)
	{
		if (!IsDynamic())
		{
			HY_CORE_WARN("Trying to set velocity of non-dynamic PhysicsActor.");
			return;
		}
	...
	glm::vec3 PhysicsActor::GetAngularVelocity() const
	{
		if (!IsDynamic())
		{
			HY_CORE_WARN("Trying to get angular velocity of non-dynamic PhysicsActor.");
			return glm::vec3(0.0F);
		}
	...
	void PhysicsActor::SetAngularVelocity(const glm::vec3& velocity)
	{
		if (!IsDynamic())
		{
			HY_CORE_WARN("Trying to set angular velocity of non-dynamic PhysicsActor.");
			return;
		}
